//
// This file holds several functions specific to the main.nf workflow in the phac-nml/metadatatransformation pipeline
//
...
class WorkflowMain {
    ...
    public static void initialise(workflow, params, log, args) {
        ...
        if (!params.input) {
            Nextflow.error("Please provide an input samplesheet to the pipeline e.g. '--input samplesheet.json'")
        }
    }
